export default {
    template: `
    <div class="row border text-white" style="border-radius: 10px; background-color: #34495E;">

      <div class="col-10 fs-2 d-flex justify-content-between align-items-center" v-if="role === ''">
        <router-link to="/" class="btn btn-primary" style="all: unset; cursor: pointer; color: white;">Quiz Master</router-link>
      </div>

      <div class="col-10 fs-2 d-flex justify-content-between align-items-center" v-if="role === 'admin'">
        <router-link to="/" class="btn btn-primary" style="all: unset; cursor: pointer; color: white;">Quiz Master</router-link>
        <router-link to="/quizzes" class="btn btn-primary" style="all: unset; cursor: pointer; color: white;">Quiz</router-link>
        <router-link to="/summary" class="btn btn-primary" style="all: unset; cursor: pointer; color: white;">Summary</router-link>
        <router-link to="/user" class="btn btn-primary" style="all: unset; cursor: pointer; color: white;">Users</router-link>
      </div>

      <div class="col-10 fs-2 d-flex justify-content-between align-items-center" v-if="role === 'user'">
        <router-link to="/" class="btn btn-primary" style="all: unset; cursor: pointer; color: white;">Quiz Master</router-link>
        <router-link to="/score" class="btn btn-primary" style="all: unset; cursor: pointer; color: white;">Score</router-link>
        <router-link to="/summary" class="btn btn-primary" style="all: unset; cursor: pointer; color: white;">Summary</router-link>
      </div>
